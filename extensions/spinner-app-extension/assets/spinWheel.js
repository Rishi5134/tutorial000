var padding = {top:20, right:40, bottom:0, left:0},
        ...
        var data = [
                    {"label":"20%",  "value":20,  "offerText":"20% OFF"}, 
                    {"label":"10%",  "value":10,  "offerText":"10% OFF"}, 
                    {"label":"5%",  "value":5,  "offerText":"5% OFF"}, 
                    {"label":"30%",  "value":30,  "offerText":"30% OFF"}, 
                    {"label":"50%",  "value":50,  "offerText":"50% OFF"}, 
                    {"label":"1%",  "value":1,  "offerText":"1% OFF"}, 
                    {"label":"0%",  "value":0,  "offerText":"0% OFF"}, 
                    {"label":"10%",  "value":10,  "offerText":"10% OFF"}, 
       ];
            ...
            vis.transition()
                ...
                .each("end", function(){
                    ...
                    d3.select("#spinnerCode")
                        .attr('value',data[picked].offerText);
        ...
        document.getElementById('spinnerImage').onclick = function(){
           ...
           if (document.getElementById('mainSpinnner').style.display == "none") {
               document.getElementById('mainSpinnner').style.display = "flex";
            //    document.getElementById('mainSpinnner').style.flexDirection = "column";
            //    document.getElementById('mainSpinnner').style.justifyContent = "center";
            //    document.getElementById('mainSpinnner').style.alignItems = "center";
               console.log('opened')
           }else {
            
            document.getElementById('mainSpinnner').style.display = "none";
            console.log('closed')
           }
        }
